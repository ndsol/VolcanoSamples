...
#include "20compute/20simple.frag.h"
#include "20compute/20simple.vert.h"

// uniform_glue.h in 20simple.h has already #included some glm headers.
...
#include "20compute/struct_20simple.vert.h"
namespace frag {
#include "20compute/struct_20simple.frag.h"
}

// A single oversize triangle can be faster than a fullscreen quad
const std::vector<st_20simple_vert> vertices = {
...
int Compressor::buildPass() {
  ...
  return cpool.setName("cpool") || pass.setName("pass") ||
         ...
         vert->loadSPV(spv_20simple_vert, sizeof(spv_20simple_vert)) ||
         frag->loadSPV(spv_20simple_frag, sizeof(spv_20simple_frag)) ||
